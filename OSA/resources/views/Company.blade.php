  ...
  <div class="page container">
    ...
    <div class="row">
      ...
      <div class="seven columns">
        <div class="company row" style="position:relative">
          @if(!Auth::check())
            <div style="position:absolute; background-color: rgba(0,0,0,0.5);top:0;bottom:0;left:0;right:0;">
              <h1 style="color:white; position: absolute; top:50%;">Log in pls huhu >_<</h1>
            </div>
          @endif
            <form>
